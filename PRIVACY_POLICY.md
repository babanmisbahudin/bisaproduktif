# Kebijakan Privasi BisaProduktif

**Terakhir diperbarui: Maret 2026**

## Pendahuluan

BisaProduktif ("Aplikasi") berkomitmen untuk melindungi privasi Anda. Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan melindungi data Anda.
...
Kami mungkin update policy ini kapan saja. Perubahan material akan:
- Dikirim via in-app notification
- Update di halaman ini dengan "Terakhir diperbarui" date
- Require explicit consent jika ada perubahan ke consent
